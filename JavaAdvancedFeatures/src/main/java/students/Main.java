...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ati intodus numele, prenumele studentului si notele la matematica, fizica " +
                "si informatica: " + nume + " " + prenume + " " + notaMate + " " + notaFiz + " " + notaInfo);

        Student student = new Student(nume, prenume, notaMate, notaFiz, notaInfo);

        try{
            student.inputGrades();
        }catch (InvalidGradeException | PerfectScoreException e){
        ...
        System.out.println("Rezultatul admiterii este: " + student.getAcceptedPol());
